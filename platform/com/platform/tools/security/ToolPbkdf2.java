...
public abstract class ToolPbkdf2 {
	...
	public static void main(String[] args) throws NoSuchAlgorithmException, InvalidKeySpecException {
		String salt = "yyaokfUd0RA=";
		byte[] base64 = Base64.decodeBase64(salt);
		byte[] password = getEncryptedPassword("yfppwd70", base64);
		String string = new BASE64Encoder().encode(password);
