...
public class DictService extends BaseService {
	...
	public void save(Dict dict) {
		...
		Long orderIds = dict.getOrderids();
		...
		dict.setIsparent("false");
		dict.setLevels(parent.getLevels() + 1);
		dict.save();
	...
	public void update(Dict dict) {
		...
		dict.setParentids(pIds);
		dict.setLevels(parent.getLevels() + 1);
		dict.setPaths(parent.getPaths() + "/" + dict.getPKValue());
		dict.update();
