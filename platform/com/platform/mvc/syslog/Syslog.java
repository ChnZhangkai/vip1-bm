...
public class Syslog extends BaseModel<Syslog> {
	...
	public void setActionendtime(Long actionendtime){
		set(column_actionendtime, isOracle() ? new BigDecimal(actionendtime) : actionendtime);
	}
	public Long getActionendtime() {
		return getNumber(column_actionendtime).longValue();
	}
	public void setActionhaoshi(Long actionhaoshi){
		set(column_actionhaoshi, isOracle() ? new BigDecimal(actionhaoshi) : actionhaoshi);
	}
	public Long getActionhaoshi() {
		return getNumber(column_actionhaoshi).longValue();
	}
	...
	public void setActionstarttime(Long actionstarttime){
		set(column_actionstarttime, isOracle() ? new BigDecimal(actionstarttime) : actionstarttime);
	}
	public Long getActionstarttime() {
		return getNumber(column_actionstarttime).longValue();
	}
	...
	public void setEndtime(Long endtime){
		set(column_endtime, isOracle() ? new BigDecimal(endtime) : endtime);
	}
	public Long getEndtime() {
		return getNumber(column_endtime).longValue();
	}
	public void setHaoshi(Long haoshi){
		set(column_haoshi, isOracle() ? new BigDecimal(haoshi) : haoshi);
	}
	public Long getHaoshi() {
		return getNumber(column_haoshi).longValue();
	}
	...
	public void setStarttime(Long starttime){
		set(column_starttime, isOracle() ? new BigDecimal(starttime) : starttime);
	}
	public Long getStarttime() {
		return getNumber(column_starttime).longValue();
	}
	...
	public void setViewhaoshi(Long viewhaoshi){
		set(column_viewhaoshi, isOracle() ? new BigDecimal(viewhaoshi) : viewhaoshi);
	}
	public Long getViewhaoshi() {
		return getNumber(column_viewhaoshi).longValue();
	}
