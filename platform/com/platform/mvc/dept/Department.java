...
public class Department extends BaseModel<Department> {
	...
	public void setDepartmentlevel(Long departmentlevel){
		set(column_departmentlevel, isOracle() ? new BigDecimal(departmentlevel) : departmentlevel);
	}
	public Long getDepartmentlevel() {
		return getNumber(column_departmentlevel).longValue();
	}
	...
	public void setOrderids(Long orderids){
		set(column_orderids, isOracle() ? new BigDecimal(orderids) : orderids);
	}
	public Long getOrderids() {
		return getNumber(column_orderids).longValue();
	}
