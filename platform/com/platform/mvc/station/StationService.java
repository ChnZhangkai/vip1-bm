...
public class StationService extends BaseService {
	 ...
	 * @return
	 */
	public String save(String pIds, String names, long orderIds) {
		Station pStation = Station.dao.findById(pIds);
		pStation.setIsparent("true");
		pStation.update();
		...
		station.setIsparent("false");
		station.setParentstationids(pIds);
		station.setOrderids(orderIds);
